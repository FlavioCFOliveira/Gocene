...
//   - SpanFirstQuery → removed (unused; real impl. in search/span_first_query.go).
//   - SpanPositionCheckQuery → removed (unused; position checking done in subclasses).
//   - SpanPositionRangeQuery → removed (unused; real impl. in search/span_position_range_query.go).

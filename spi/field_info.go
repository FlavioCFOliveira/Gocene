...
// GetIndexOptions returns the index options. Port of
// FieldInfo.getIndexOptions() (FieldInfo.java:565); it delegates to
// IndexOptions so there is one implementation of the accessor.
func (fi *FieldInfo) GetIndexOptions() IndexOptions {
	return fi.IndexOptions()
}
...
func (fi *FieldInfo) VectorEncoding() util.VectorEncoding {
	return fi.vectorEncoding
}

// GetVectorEncoding returns the encoding of vector values. Port of
// FieldInfo.getVectorEncoding() (FieldInfo.java:534); it delegates to
// VectorEncoding so there is one implementation of the accessor.
func (fi *FieldInfo) GetVectorEncoding() util.VectorEncoding {
	return fi.VectorEncoding()
}

// VectorSimilarityFunction returns the similarity function for vector values.
func (fi *FieldInfo) VectorSimilarityFunction() util.VectorSimilarityFunction {
...
// HasVectorValues reports whether any (numeric) vector values exist for this
// field. Port of FieldInfo.hasVectorValues() (FieldInfo.java:653), which tests
// vectorDimension > 0.
...
func (b *FieldInfoBuilder) SetVectorAttributes(dimension int, encoding util.VectorEncoding, similarity util.VectorSimilarityFunction) *FieldInfoBuilder {

...
// Purpose: Verify that the index can be written and read correctly.
...
// TestAllFilesDetectMismatchedChecksum writes a small index and verifies it
// can be reopened and read.

...
// init publishes STUniformSplitPostingsFormat in the global PostingsFormat
// registry under its Lucene name, "SharedTermsUniformSplit".
//
// Mirrors the ServiceLoader entry
// org.apache.lucene.codecs.uniformsplit.sharedterms.STUniformSplitPostingsFormat
// in lucene/codecs/src/resources/META-INF/services/org.apache.lucene.codecs.PostingsFormat
//
...
func init() {
	format, err := NewSTUniformSplitPostingsFormat()
	if err != nil {
		panic("codecs/uniformsplit/sharedterms: failed to create STUniformSplitPostingsFormat: " + err.Error())
	}

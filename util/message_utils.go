...
// MessageBundleBasename is the basename of the resource bundle used for messages.
var MessageBundleBasename = "org/apache/lucene/luke/app/desktop/messages/messages"
...
// GetLocalizedMessage retrieves a localized message from the bundle by key.
...
// GetLocalizedMessageWithArgs retrieves a localized message and formats it with the provided arguments.
// It replaces placeholders like {0}, {1}, etc. with the corresponding arguments.
func GetLocalizedMessageWithArgs(key string, args ...interface{}) string {
	pattern, ok := bundle[key]
	if !ok {
		return key
	}

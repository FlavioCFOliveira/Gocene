...
// This file has no Apache Lucene 10.5.0 counterpart. Its types were declared
// in the former Gocene package grouping/ (which mirrors
// org.apache.lucene.search.grouping, a package that declares no ValueSource)
// and are used only by this package's distance value sources, so they were
// relocated here unchanged when grouping/ was consolidated into
// search/grouping. In Lucene 10.5.0 SpatialStrategy.makeDistanceValueSource
// returns org.apache.lucene.search.DoubleValuesSource; retargeting the
// spatial strategies to search.DoubleValuesSource is a separate fidelity

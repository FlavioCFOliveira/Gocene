...
func NewLucene90BoundsChecker(version string) *Lucene90BoundsChecker {
	return &Lucene90BoundsChecker{Name: "Lucene90BoundsChecker", Version: version}
}
...
func NewLucene90Codec(version string) *Lucene90Codec {
	return &Lucene90Codec{Name: "Lucene90Codec", Version: version}
}
...
func NewLucene90FieldInfosFormat(version string) *Lucene90FieldInfosFormat {
	return &Lucene90FieldInfosFormat{Name: "Lucene90FieldInfosFormat", Version: version}
}
...
func NewLucene90HnswGraphBuilder(version string) *Lucene90HnswGraphBuilder {
	return &Lucene90HnswGraphBuilder{Name: "Lucene90HnswGraphBuilder", Version: version}
}
...
func NewLucene90HnswVectorsFormat(version string) *Lucene90HnswVectorsFormat {
	return &Lucene90HnswVectorsFormat{Name: "Lucene90HnswVectorsFormat", Version: version}
}
...
func NewLucene90NeighborArray(version string) *Lucene90NeighborArray {
	return &Lucene90NeighborArray{Name: "Lucene90NeighborArray", Version: version}
}
...
func NewLucene90OnHeapHnswGraph(version string) *Lucene90OnHeapHnswGraph {
	return &Lucene90OnHeapHnswGraph{Name: "Lucene90OnHeapHnswGraph", Version: version}
}
...
func NewLucene90SegmentInfoFormat(version string) *Lucene90SegmentInfoFormat {
	return &Lucene90SegmentInfoFormat{Name: "Lucene90SegmentInfoFormat", Version: version}
}
...
func NewLucene90HnswVectorsReader(version string) *Lucene90HnswVectorsReader {
	return &Lucene90HnswVectorsReader{Name: "Lucene90HnswVectorsReader", Version: version}
}
...
func NewLucene90PostingsFormat(version string) *Lucene90PostingsFormat {
	return &Lucene90PostingsFormat{Name: "Lucene90PostingsFormat", Version: version}
}
...
func NewLucene90PostingsReader(version string) *Lucene90PostingsReader {
	return &Lucene90PostingsReader{Name: "Lucene90PostingsReader", Version: version}
}
...
func NewLucene90PostingsWriter(version string) *Lucene90PostingsWriter {
	return &Lucene90PostingsWriter{Name: "Lucene90PostingsWriter", Version: version}
}

...
// TestBasicBackwardsCompatibility is a test-support type mirroring the Java class
// org.apache.lucene.backward_index.TestBasicBackwardsCompatibility (in the Lucene test tree).
//

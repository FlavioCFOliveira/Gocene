...
// TestMoreTermsBackwardsCompatibility is a test-support type mirroring the Java class
// org.apache.lucene.backward_index.TestMoreTermsBackwardsCompatibility (in the Lucene test tree).
//

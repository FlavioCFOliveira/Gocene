...
// TestIndexSortBackwardsCompatibility is a test-support type mirroring the Java class
// org.apache.lucene.backward_index.TestIndexSortBackwardsCompatibility (in the Lucene test tree).
//

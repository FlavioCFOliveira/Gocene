...
// TestInt7HnswBackwardsCompatibility is a test-support type mirroring the Java class
// org.apache.lucene.backward_index.TestInt7HnswBackwardsCompatibility (in the Lucene test tree).
//

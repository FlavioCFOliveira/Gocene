...
// BackwardsCompatibilityTestBase is a test-support type mirroring the Java class
// org.apache.lucene.backward_index.BackwardsCompatibilityTestBase (in the Lucene test tree).
//

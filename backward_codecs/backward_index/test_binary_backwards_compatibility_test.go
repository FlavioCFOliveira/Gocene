...
// TestBinaryBackwardsCompatibility is a test-support type mirroring the Java class
// org.apache.lucene.backward_index.TestBinaryBackwardsCompatibility (in the Lucene test tree).
//

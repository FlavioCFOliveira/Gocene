...
// TestDVUpdateBackwardsCompatibility is a test-support type mirroring the Java class
// org.apache.lucene.backward_index.TestDVUpdateBackwardsCompatibility (in the Lucene test tree).
//

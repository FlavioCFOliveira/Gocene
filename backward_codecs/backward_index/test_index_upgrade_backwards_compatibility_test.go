...
// TestIndexUpgradeBackwardsCompatibility is a test-support type mirroring the Java class
// org.apache.lucene.backward_index.TestIndexUpgradeBackwardsCompatibility (in the Lucene test tree).
//

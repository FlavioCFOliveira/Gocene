...
// TestEmptyIndexBackwardsCompatibility is a test-support type mirroring the Java class
// org.apache.lucene.backward_index.TestEmptyIndexBackwardsCompatibility (in the Lucene test tree).
//

...
func NewForDeltaUtil(version string) *ForDeltaUtil {
	return &ForDeltaUtil{Name: "ForDeltaUtil", Version: version}
}
...
func NewLucene99HnswScalarQuantizedVectorsFormat(version string) *Lucene99HnswScalarQuantizedVectorsFormat {
	return &Lucene99HnswScalarQuantizedVectorsFormat{Name: "Lucene99HnswScalarQuantizedVectorsFormat", Version: version}
}
...
func NewLucene99ScalarQuantizedVectorsFormat(version string) *Lucene99ScalarQuantizedVectorsFormat {
...
func NewLucene99SkipWriter(version string) *Lucene99SkipWriter {
	return &Lucene99SkipWriter{Name: "Lucene99SkipWriter", Version: version}
}
...
func NewOffHeapQuantizedByteVectorValues(version string) *OffHeapQuantizedByteVectorValues {
	return &OffHeapQuantizedByteVectorValues{Name: "OffHeapQuantizedByteVectorValues", Version: version}
}
...
func NewLucene99PostingsFormat(version string) *Lucene99PostingsFormat {
	return &Lucene99PostingsFormat{Name: "Lucene99PostingsFormat", Version: version}
}
...
func NewLucene99ScalarQuantizedVectorsReader(version string) *Lucene99ScalarQuantizedVectorsReader {
	return &Lucene99ScalarQuantizedVectorsReader{Name: "Lucene99ScalarQuantizedVectorsReader", Version: version}
}
...
func NewLucene99Codec(version string) *Lucene99Codec {
	return &Lucene99Codec{Name: "Lucene99Codec", Version: version}
}
...
func NewLucene99PostingsReader(version string) *Lucene99PostingsReader {
	return &Lucene99PostingsReader{Name: "Lucene99PostingsReader", Version: version}
}

...
func NewLucene84PostingsFormat(version string) *Lucene84PostingsFormat {
	return &Lucene84PostingsFormat{Name: "Lucene84PostingsFormat", Version: version}
}
...
func NewLucene84PostingsReader(version string) *Lucene84PostingsReader {
	return &Lucene84PostingsReader{Name: "Lucene84PostingsReader", Version: version}
}
...
func NewLucene84Codec(version string) *Lucene84Codec {
	return &Lucene84Codec{Name: "Lucene84Codec", Version: version}
}

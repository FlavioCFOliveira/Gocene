...
func NewLucene92HnswVectorsReader(version string) *Lucene92HnswVectorsReader {
	return &Lucene92HnswVectorsReader{Name: "Lucene92HnswVectorsReader", Version: version}
}

...
| GC-092 | LOW | Implement Index - KeepOnlyLastCommitDeletionPolicy | go-elite-developer | 2026-03-13 | Created KeepOnlyLastCommitDeletionPolicy keeping only the most recent commit. Also includes KeepAllDeletionPolicy and SnapshotDeletionPolicy for advanced use cases. Location: index/keep_only_last_commit_deletion_policy.go |
| GC-091 | LOW | Implement Index - IndexDeletionPolicy | go-elite-developer | 2026-03-13 | Created IndexDeletionPolicy interface with OnCommit, OnInit, Clone methods. Includes helper functions: EnsureCommitsValid, FindCommitByGeneration, FilterDeletedCommits, DeleteCommits. Location: index/index_deletion_policy.go |
| GC-090 | LOW | Implement Index - IndexCommit | go-elite-developer | 2026-03-13 | Created IndexCommit struct with GetSegmentsFileName, GetSegmentCount, GetDirectory, GetGeneration, GetFileNames, Delete, IsDeleted methods. Includes IndexCommitList type with sorting utilities. Location: index/index_commit.go |

...
func (w *logOddsFusionWeight) Scorer(context *index.LeafReaderContext) (Scorer, error) {
...
func (w *logOddsFusionWeight) BulkScorer(context *index.LeafReaderContext) (BulkScorer, error) {
	scorerSupplier, err := w.ScorerSupplier(context)
	if err != nil || scorerSupplier == nil {
		// No docs match
		return nil, err

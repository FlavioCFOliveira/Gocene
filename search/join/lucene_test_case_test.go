...
// This file renders, for the internal search/join test package, the members of
...
// sets the randomized class similarity (classEnvRule.similarity), which is
// not ported.
...
// boolean maybeWrap), which delegates to newSearcher(r, maybeWrap, true) and
// therefore builds an AssertingIndexSearcher.
...
// newLogMergePolicyUseCFS renders LuceneTestCase.newLogMergePolicy(boolean
// useCFS).
func newLogMergePolicyUseCFS(useCFS bool) index.MergePolicy {

...
// Similarity is the Lucene 10.4.0 canonical Similarity contract.
//
...
// and produce a query-time SimScorer through Scorer104.
//
...
type Similarity interface {
	...
	// Scorer104 builds a SimScorer for the supplied collection and
	// term statistics, mirroring Similarity.scorer(float, CollectionStatistics,
	// TermStatistics...).
	Scorer104(boost float32, collectionStats *CollectionStatistics, termStats ...*TermStatistics) SimScorer
}

// SimScorer is the Lucene 10.4.0 SimScorer contract.
//
...
// DefaultBulkSimScorer wraps a SimScorer in a straight-line loop. It
// is the fallback returned by SimScorer implementations that do not

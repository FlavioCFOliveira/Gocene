...
// org.apache.lucene.analysis.ko.dict.TokenInfoDictionaryWriter from Apache
// Lucene 10.4.0.
//
...
// public struct; binary serialisation is deferred to the nori codec sprint.
...
func (w *TokenInfoDictionaryWriter) Entries() [][]byte { return w.entries }

// POSDict returns all accumulated POS tag strings.
func (w *TokenInfoDictionaryWriter) POSDict() []string { return w.posDict }

...
func TestGraphTokenizers_MockGraphTokenFilterBasic(t *testing.T) {
	t.Skip("requires BaseTokenStreamTestCase/MockGraphTokenFilter infrastructure (not yet ported to Gocene)")
}
...
func TestGraphTokenizers_SingleToken(t *testing.T) {
	t.Skip("requires BaseTokenStreamTestCase/CannedTokenStream infrastructure (not yet ported to Gocene)")
}
...
func TestGraphTokenizers_ToDot(t *testing.T) {
	t.Skip("requires BaseTokenStreamTestCase/TokenStreamToDot infrastructure (not yet ported to Gocene)")
}
